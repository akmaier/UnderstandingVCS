...
**Totals after P4d + PXC1-x round 3 + 3.5 + P7e-x extension + P7c-dx jutari: jaxtari 552 tests (+ 1 xfail), jutari 1142 tests (+ 1 broken) — 1695 effective.** One xfail remains, recording the PXC1-x round 2+ bit-exact gap (10 RAM bytes). PXC1-x round 4 added a write-tracer diagnostic but the gap is unchanged pending the dump-pot timing model.
