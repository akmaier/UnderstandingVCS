...
\begin{itemize}
	...
	yes --- every reported result states its run count: throughput is the median of three timed runs per configuration, and the conformance/exactness results are deterministic and reported from a single exact run (zero variance by construction)
