...
this size is real but uneven across systems.
...
it uses Atari ROMs only as fixed computational inputs. The agentic
software-engineering method we report is dual-use, but coupling autonomy to a
strict, automatically checked conformance oracle keeps it safe, and our
intended use---validating XAI against known ground truth---supports the
