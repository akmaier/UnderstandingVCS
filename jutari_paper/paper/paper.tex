...
object model rather than approximating its output---deferred sprite
repositioning, the reset-then-skip-first-copy rule, the vertical-delay shadow
latch, and the playfield-reflect gate---following the principle that the
mechanism, not the scoreboard, is what must match, because the eventual XAI
attribution projects gradients onto this very frame buffer.
