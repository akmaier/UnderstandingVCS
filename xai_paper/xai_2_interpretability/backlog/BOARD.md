...
| P2-R-S02-related | Revise related work — add MIB/SAEBench/M4 + substrate-adjacent Atari, reorganize, tone "first" | RV | 12 | — | local | todo | P2-R-REF | `paper/sections/02_related.tex` |
...
| P2-R-S04-resultsA | Revise Results Phase A — per-game values + CIs, justify analogues, Fig3 caption fixes | RV | 12 | — | local | todo | P2-R-UNC, P2-R-F3 | `paper/sections/04_results_A.tex` |
| P2-R-S05-resultsB | Revise Results Phase B — separate regimes, baselines/variance, CIs, drop "default tool", §1→§3.2, Fig4 caption | RV | 12 | — | local | todo | P2-R-UNC, P2-R-F4 | `paper/sections/05_results_B.tex` |
| P2-R-S06-resultsC | Revise Results Phase C — oracle-equiv controls, ACDC/SAE/probe rigor + CIs, "verified:false", §refs | RV | 12 | — | local | todo | P2-R-UNC | `paper/sections/06_results_C.tex` |
...
## Items per sprint
Sprint 0: 3, Sprint 1: 6, Sprint 10: 6, Sprint 11: 3, Sprint 12: 4, Sprint 2: 1, Sprint 3: 4, Sprint 4: 8, Sprint 5: 23, Sprint 6: 11, Sprint 7: 10, Sprint 8: 4, Sprint 9: 3, Sprint ?: 4
