...
> Auto-generated by `build_board.py` from the `P2-*.md` frontmatter. **98 items.** SM-only (SCRUM §2); regenerate at each Planning/Review. Per-sprint file-scope disjointness is enforced at Planning (SCRUM §0).
...
| P2-R-S04-resultsA | Revise Results Phase A — per-game values + CIs, justify analogues, Fig3 caption fixes | RV | 12 | — | local | done | P2-R-UNC, P2-R-F3 | `paper/sections/04_results_A.tex` |
| P2-R-S05-resultsB | Revise Results Phase B — separate regimes, baselines/variance, CIs, drop "default tool", §1→§3.2, Fig4 caption | RV | 12 | — | local | done | P2-R-UNC, P2-R-F4 | `paper/sections/05_results_B.tex` |
| P2-R-S06-resultsC | Revise Results Phase C — oracle-equiv controls, ACDC/SAE/probe rigor + CIs, "verified:false", §refs | RV | 12 | — | local | done | P2-R-UNC | `paper/sections/06_results_C.tex` |
| P2-R-S07-compare | Revise leaderboard section — canonical count, exploratory framing, proxy, "verified:false", Fig2+Fig6 captions | RV | 11 | — | local | done | P2-R-UNC, P2-R-F2, P2-R-F6, P2-R-REF | `paper/sections/07_results_compare.tex` |
| P2-R-S08-discussion | Revise discussion — tone down NN-transfer/"no business", precise recommendations, Fig5 caption | RV | 13 | — | local | done | P2-R-F5 | `paper/sections/08_discussion.tex` |
| P2-R-S09-endmatter | Revise endmatter — code review-time availability, [33]/[34] as archived artifacts, Paper-1 cite, contributions | RV | 13 | — | local | done | P2-R-REPRO, P2-R-REF | `paper/sections/09_endmatter.tex` |
| P2-R-SUPP | New Supplementary Information — per-method protocols, schemas, claims/provenance, no-claim box | RV | 11 | — | local | done | P2-R-UNC | `paper/supplement/supplement.tex`<br>`paper/supplement/S1_per_method_protocols.tex`<br>`paper/supplement/S2_benchmark_schema.tex`<br>`paper/supplement/S3_coverage_applicability.tex`<br>`paper/supplement/S4_claims_evidence.tex`<br>`paper/supplement/S5_number_provenance.tex`<br>`paper/supplement/S6_not_claimed.tex` |
...
| P2-N-CONSISTENCY | Full-paper consistency scan — main text, figures, tables, captions, supplement | RV | 15 | agent-1 | local | done |  | `paper/sections/*.tex`<br>`paper/supplement/*.tex` |
| P2-N-SENT | Split overly long sentences throughout the paper (style pass) | RV | 16 | agent-1 | local | done | P2-N-CONSISTENCY | `paper/sections/*.tex`<br>`paper/supplement/*.tex` |
| P2-N-ABSTRACT | Replace abstract with condensed version from most important findings | RV | 17 | agent-1 | local | done | P2-N-SENT | `paper/sections/00_abstract.tex` |
| P2-3M-METHODS | Update methods section: three Paper-1 modes, Paper 1 as technical companion, three oracles | 3M | | | local | todo |  | `paper/sections/03_methods.tex` |
| P2-3M-RUNNER | Build multi-mode experiment runner for gradient XAI (SOFT-STE + SOFT with alpha/T grid) | 3M | | | local | todo | P2-3M-METHODS | `tools/xai_study/phaseB_attribution/multi_mode_runner.jl` |
| P2-3M-STE | Run gradient XAI methods in SOFT-STE mode across 6 core games | 3M | | | local | todo | P2-3M-RUNNER | `tools/xai_study/phaseB_attribution/out/multimode_ste_*` |
| P2-3M-SOFT | Run gradient XAI methods in SOFT mode with alpha/T grid sweep | 3M | | | cluster | todo | P2-3M-RUNNER | `tools/xai_study/phaseB_attribution/out/multimode_soft_*` |
| P2-3M-RESULTS-B | Update Results B with STE and soft-mode findings | 3M | | | local | todo | P2-3M-STE, P2-3M-SOFT | `paper/sections/05_results_B.tex` |
| P2-3M-COMPARE | Update Results Compare with three-oracle framing | 3M | | | local | todo | P2-3M-RESULTS-B | `paper/sections/07_results_compare.tex` |
| P2-3M-DISCUSSION | Update discussion + abstract + consistency scan for three-mode framing | 3M | | | local | todo | P2-3M-COMPARE | `paper/sections/01_intro.tex`<br>`paper/sections/08_discussion.tex`<br>`paper/sections/00_abstract.tex`<br>`paper/sections/04_results_A.tex`<br>`paper/sections/06_results_C.tex`<br>`paper/sections/09_endmatter.tex` |

## Items per sprint
Sprint 0: 3, Sprint 1: 6, Sprint 10: 6, Sprint 11: 3, Sprint 12: 4, Sprint 13: 3, Sprint 14: 1, Sprint 2: 1, Sprint 3: 4, Sprint 4: 8, Sprint 5: 23, Sprint 6: 11, Sprint 7: 10, Sprint 8: 4, Sprint 9: 3
