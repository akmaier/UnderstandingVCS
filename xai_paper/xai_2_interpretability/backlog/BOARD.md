...
| P2-R-F1 | Redraw Fig 1 (platform/oracle) — jutari(Julia), plausibility-proxy, split/declutter, fonts | RV |  | — | local | todo |  | `paper/figures/fig1_platform_oracle.py` |
| P2-R-F2 | Redraw Fig 2 (Kording battery) — fix callout overlaps, legends outside, key-findings table, fonts | RV |  | — | local | todo | P2-R-UNC | `paper/figures/fig2_faithfulness_vs_plausibility.py` |
| P2-R-F3 | Redraw Fig 3 (attribution vs mechanistic) — facet strips, legends outside, mark oracle-like, fonts | RV |  | — | local | todo | P2-R-UNC | `paper/figures/fig3_phaseA_battery.py` |
