...
| P2-E4-3 | Guided Backprop attribution vs oracle (+ sanity checks) | E4 | 5 | — | local | todo | P2-E4-0 | `tools/xai_study/phaseB_attribution/guided_backprop.py`<br>`tools/xai_study/phaseB_attribution/out/guided_backprop_*` |
...
| P2-E4-5 | Integrated Gradients attribution vs oracle (+ baseline sweep) | E4 | 5 | — | local | todo | P2-E4-0 | `tools/xai_study/phaseB_attribution/integrated_gradients.py`<br>`tools/xai_study/phaseB_attribution/out/integrated_gradients_*` |
...
| P2-E5-8 | Causal scrubbing — hypothesis pass/fail vs true routine | E5 | 3 | — | cluster | todo | P2-E5-0 | `tools/xai_study/phaseC_mechanistic/causal_scrubbing.py`<br>`tools/xai_study/phaseC_mechanistic/out/causal_scrubbing_*` |
| P2-E5-9 | Linear probing + control tasks — present-vs-used gap | E5 | 3 | — | cluster | todo | P2-E5-0 | `tools/xai_study/phaseC_mechanistic/probing_control.py`<br>`tools/xai_study/phaseC_mechanistic/out/probing_control_*` |
| P2-E5-10 | Logit / tuned lens — readout fidelity vs true intermediate | E5 | 3 | — | cluster | todo | P2-E5-0 | `tools/xai_study/phaseC_mechanistic/logit_tuned_lens.py`<br>`tools/xai_study/phaseC_mechanistic/out/logit_tuned_lens_*` |
...
## Items per sprint
Sprint 0: 3, Sprint 1: 6, Sprint 2: 3, Sprint 3: 22, Sprint 4: 8, Sprint 5: 14, Sprint 6: 10, Sprint 7: 4
