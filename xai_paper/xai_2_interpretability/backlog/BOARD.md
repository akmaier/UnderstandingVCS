...
> Auto-generated by `build_board.py` from the `P2-*.md` frontmatter. **69 items.** SM-only (SCRUM §2); regenerate at each Planning/Review. Per-sprint file-scope disjointness is enforced at Planning (SCRUM §0).
...
| P2-E4-0 | Phase-B pilot — IG vs oracle (one output, one game) | E4 | 2 | — | local | todo | P2-E1-1, P2-E1-2 | `tools/xai_study/phaseB_attribution/pilot_ig_vs_oracle.py`<br>`tools/xai_study/phaseB_attribution/out/pilotB_*` |
...
| P2-E5-0 | Phase-C pilot — activation patching + 1 SAE on VCS state | E5 | 2 | — | local | todo | P2-E1-1, P2-E0-2 | `tools/xai_study/phaseC_mechanistic/pilot_patch_sae.py`<br>`tools/xai_study/phaseC_mechanistic/out/pilotC_*` |
...
## Items per sprint
Sprint 0: 3, Sprint 1: 6, Sprint 2: 5, Sprint 3: 32, Sprint 5: 9, Sprint 6: 10, Sprint 7: 4
