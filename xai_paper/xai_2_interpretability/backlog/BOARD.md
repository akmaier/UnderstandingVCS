...
| P2-E7-2 | Figure 2 — A–C on the shared faithfulness-vs-plausibility axes (headline) | E7 | 6 | — | local | todo | P2-E6-1, P2-E6-3 | `paper/figures/fig_2.py`<br>`paper/figures/fig_2.pdf` |
| P2-E7-3 | Figure 3 — the Kording neuroscience battery, scored | E7 | 6 | — | local | todo | P2-E6-1 | `paper/figures/fig_3.py`<br>`paper/figures/fig_3.pdf` |
| P2-E7-4 | Figure 4 — attribution (Phase B) vs mechanistic interp (Phase C) | E7 | 6 | — | local | todo | P2-E6-1 | `paper/figures/fig_4.py`<br>`paper/figures/fig_4.pdf` |
| P2-E7-5 | Figure 5 — VCS↔NN failure-mode / representativeness map | E7 | 5 | — | local | todo |  | `paper/figures/fig_5.py`<br>`paper/figures/fig_5.pdf` |
| P2-E7-6 | Figure 6 — failure taxonomy | E7 | 5 | — | local | todo |  | `paper/figures/fig_6.py`<br>`paper/figures/fig_6.pdf` |
...
| P2-E8-3 | Write the related-work section | E8 | 6 | — | local | todo | P2-E8-0 | `paper/sections/02_related.tex` |
| P2-E8-4 | Write the methods section (emulator, oracle, metrics) | E8 | 6 | — | local | todo | P2-E8-0 | `paper/sections/03_methods.tex` |
| P2-E8-5 | Write results A (neuroscience battery) | E8 | 6 | — | local | todo | P2-E8-0, P2-E6-1, P2-E7-3 | `paper/sections/04_results_A.tex` |
| P2-E8-6 | Write results B (attribution / XAI) | E8 | 6 | — | local | todo | P2-E8-0, P2-E6-1, P2-E7-4 | `paper/sections/05_results_B.tex` |
| P2-E8-7 | Write results C (mechanistic interpretability) | E8 | 6 | — | local | todo | P2-E8-0, P2-E6-1, P2-E7-4 | `paper/sections/06_results_C.tex` |
| P2-E8-8 | Write the results-comparison section | E8 | 6 | — | local | todo | P2-E8-0, P2-E6-1, P2-E6-3, P2-E7-2 | `paper/sections/07_results_compare.tex` |
| P2-E8-9 | Write discussion + end-matter | E8 | 6 | — | local | todo | P2-E8-0, P2-E6-1 | `paper/sections/08_discussion.tex`<br>`paper/sections/09_endmatter.tex` |
...
## Items per sprint
Sprint 0: 3, Sprint 1: 6, Sprint 2: 1, Sprint 3: 4, Sprint 4: 8, Sprint 5: 25, Sprint 6: 19, Sprint 7: 4
