...
> Auto-generated by `build_board.py` from the `P2-*.md` frontmatter. **90 items.** SM-only (SCRUM §2); regenerate at each Planning/Review. Per-sprint file-scope disjointness is enforced at Planning (SCRUM §0).
...
| P2-R-S01-intro | Revise intro — cut 25-35%, tone down, scope NN-transfer claim, fix oracle/section refs | RV | 13 | — | local | todo |  | `paper/sections/01_intro.tex` |
...
| P2-R-S08-discussion | Revise discussion — tone down NN-transfer/"no business", precise recommendations, Fig5 caption | RV | 13 | — | local | todo | P2-R-F5 | `paper/sections/08_discussion.tex` |
| P2-R-S09-endmatter | Revise endmatter — code review-time availability, [33]/[34] as archived artifacts, Paper-1 cite, contributions | RV | 13 | — | local | todo | P2-R-REPRO, P2-R-REF | `paper/sections/09_endmatter.tex` |
...
## Items per sprint
Sprint 0: 3, Sprint 1: 6, Sprint 10: 6, Sprint 11: 3, Sprint 12: 4, Sprint 13: 3, Sprint 2: 1, Sprint 3: 4, Sprint 4: 8, Sprint 5: 23, Sprint 6: 11, Sprint 7: 10, Sprint 8: 4, Sprint 9: 3, Sprint ?: 1
