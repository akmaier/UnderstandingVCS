...
%%=============================================================%%
\title[Faithful attribution recovers the causal wiring, not the semantics]{Faithful attribution recovers the causal wiring, not the semantics: a ground-truth audit of interpretability on a fully known machine}
...
%%=============================================================%%
%% Body — one \input per section (SCRUM §6 ordering).
%%=============================================================%%
\input{sections/01_intro}
\input{sections/02_related}
\input{sections/03_methods}
\input{sections/04_results_A}
\input{sections/05_results_B}
\input{sections/06_results_C}
\input{sections/07_results_compare}
