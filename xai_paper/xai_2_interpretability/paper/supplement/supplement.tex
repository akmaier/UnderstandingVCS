...
record file and command that produced it (Sec.~\ref{supp:provenance}), and a plain
statement of what the paper does not claim (Sec.~\ref{supp:notclaimed}). The two
