...
per-method protocols (Sec.~\ref{supp:protocols}), the leaderboard schema and its glossary
(Sec.~\ref{supp:schema}), the coverage and applicability of every method across games and
output regimes (Sec.~\ref{supp:coverage}), the mapping from each headline claim to its
evidence (Sec.~\ref{supp:claims}), the provenance of every headline number down to the
record file and command that produced it (Sec.~\ref{supp:provenance}), a plain
