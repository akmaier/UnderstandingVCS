...
one defined in the main Methods (\S3.4); we reference it here rather than restating it. The
benchmark scores 30 interpretability methods together with the intervention oracle (\S3.2)
