...
its sensitivity analysis (\Sectionname\ref{supp:plausibility}). We list a SHA-256 hash for
each ROM in the bit-exact roster (\Sectionname\ref{supp:romhashes}), so the exact game
binaries can be verified without our redistributing them.
...
\input{supplement/S8_rom_hashes}
