...
the 42-game scored set of \Sectionname\ref{supp:scoredset}, not the six-game core;
...
One number needs a note, and we record it rather than hide it. On the 42-game scored set
