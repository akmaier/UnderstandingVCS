...
rank correlation between faithfulness and the proxy is $-0.48$, a negative association.
The traditions the field finds most convincing are, on this machine, among the least faithful.
Twelve methods fall in the danger zone, defined here as a proxy of at least $0.70$ together
with a faithfulness below $0.40$. They include the four correlational neuroscience analyses
(A3--A6), the gradient methods (vanilla saliency, SmoothGrad, guided backprop, integrated
gradients, expected gradients), linear probing, the NMF/PCA dictionaries, and the sparse
autoencoder. The per-method extreme
...
from $-0.79$ to $-0.07$. The danger zone stays populated, with
between seven and thirteen methods. The per-method anchor sign holds in every scheme where both
...
plausible and least faithful block at once, and still leaves seven danger-zone methods and a rank
correlation of $-0.79$. The weakest is the leave-the-causal-tradition-out run, where the
correlation falls to $-0.07$, close to zero; removing the faithful causal block flattens the
...
\midrule
baseline                & ---           & 30 & $-0.48$ & 12 & 1 \\
additive jitter         & $\sigma=0.05$ & 30 & $-0.50$ & 12 & 1 \\
additive jitter         & $\sigma=0.10$ & 30 & $-0.52$ & 12 & 1 \\
additive jitter         & $\sigma=0.20$ & 30 & $-0.55$ & 13 & 1 \\
rank-preserving         & $\sigma=0.10$ & 30 & $-0.48$ & 12 & 1 \\
rank-preserving         & $\sigma=0.20$ & 30 & $-0.48$ & 12 & 1 \\
rank-jittering          & $\sigma=0.10$ & 30 & $-0.52$ & 12 & 1 \\
rank-jittering          & $\sigma=0.20$ & 30 & $-0.55$ & 13 & 1 \\
leave-out causal        & ---           & 24 & $-0.07$ & 12 & \\
leave-out correlational & ---           & 26 & $-0.57$ &  8 & 1 \\
leave-out descriptive   & ---           & 29 & $-0.42$ & 12 & 1 \\
leave-out dim.\ red.    & ---           & 27 & $-0.53$ & 10 & 1 \\
leave-out gradient      & ---           & 20 & $-0.79$ &  7 & \\
leave-out intervention  & ---           & 25 & $-0.39$ & 12 & 1 \\
leave-out probing       & ---           & 29 & $-0.50$ & 11 & 1 \\
\bottomrule
\end{tabular}
\end{table}
