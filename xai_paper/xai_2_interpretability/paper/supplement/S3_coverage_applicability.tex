...
Table~\ref{supp:tab:coverage}. We pick these six because all three tiers of ground truth
(\Sectionname3.3) are available for them and the oracle is exact. The remaining 58 games are
...
external (\Sectionname3.3); we record this so the benchmark does not appear to certify them.}
