...
\jkey{n_games} & number of games the method was scored on (up to 42 for the scored battery of \Sectionname\ref{supp:scoredbattery}; 1 for the oracle) \\
...
(\texttt{leaderboard.json.n\_methods}~$=31$), aggregating 1736 per-game records over the
42-game scored battery (\texttt{n\_per\_game\_records\_aggregated}~$=1736$): 8 methods in
