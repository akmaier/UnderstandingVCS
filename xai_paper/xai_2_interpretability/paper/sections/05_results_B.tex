...
have the higher plausibility proxy, the danger zone of \Sectionname\ref{sec:results_compare}
in numbers. The Phase-C half (b) is discussed in \Sectionname\ref{sec:results-c}. The figure
...
of \Sectionname\ref{sec:methods}, now a measured number. Averaged over all output regimes
...
$1.000$, bit-exact on every game. Yet, on the plausibility proxy of \Sectionname\ref{sec:methods}
...
\emph{proxy} (\Sectionname\ref{sec:methods}), \emph{not} a human measurement.
