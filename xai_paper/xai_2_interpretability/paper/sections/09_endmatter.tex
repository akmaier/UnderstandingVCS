...
% P2-E8-9 (P2 Sprint 7). Voice: ../STYLE.md (Andreas Maier). Requirements:
% document_check.md §D.
...
% run-in labels (STYLE.md §1/§3) — Data availability, Code availability (incl. the
% exact "released under the MIT license upon acceptance." line), Author
