...
Tier-3 game-concept name, the word ``ball'' or ``missile'' attached to the byte it points at,
...
plausibility proxy ($0.9$ versus $0.5$). We measure the semantic gap relative to these numbers.
