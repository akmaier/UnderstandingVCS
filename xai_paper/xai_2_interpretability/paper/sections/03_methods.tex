...
cause that an external label only names later. An attribution map, which returns weights over
causes and never a name, scores semantic recovery $0$ by construction. Faithfulness and
semantic recovery are two independent axes. Faithfulness asks whether the method names the
right cause. Semantic recovery asks whether it names any meaning. The keystone experiment of
