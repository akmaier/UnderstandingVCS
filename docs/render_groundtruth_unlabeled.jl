...
const UNLABELED10 = ["defender","elevator_action","gravitar","journey_escape","solaris","surround","tutankham","videochess","wizard_of_wor","zaxxon"]
...
println("\n==== SUMMARY ====")
println("wrote $(length(ok))/$(length(UNLABELED10)) PNGs to $OUTDIR")
